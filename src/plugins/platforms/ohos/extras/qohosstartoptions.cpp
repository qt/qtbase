...
/*!
    \class QtHarmonyExtras::StartOptions
...
/*!
    \enum QtHarmonyExtras::StartOptions::ProcessMode
    \since 5.12.12
...
/*!
    \enum QtHarmonyExtras::StartOptions::StartupVisibility
    \since 5.12.12
...
/*!
    \enum QtHarmonyExtras::StartOptions::WindowMode
    \since 5.12.12
...
/*!
    \enum QtHarmonyExtras::StartOptions::SupportWindowMode
    \since 5.12.12
...
/*!
    \class QtHarmonyExtras::WindowCreateParams
    \inmodule QtHarmonyExtras
    \since 5.12.12
...
/*!
    \enum QtHarmonyExtras::WindowCreateParams::AnimationType
    \since 5.12.12
...
public:
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWindowMode(WindowMode windowMode)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setDisplayId(int displayId)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWithAnimation(bool withAnimation)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWindowLeft(int windowLeft)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWindowTop(int windowTop)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWindowWidth(int windowWidth)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWindowHeight(int windowHeight)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setProcessMode(ProcessMode processMode)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setStartupVisibility(StartupVisibility startupVisibility)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setStartWindowIcon(const QImage &startWindowIcon)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setStartWindowBackgroundColor(const QColor &startWindowBackgroundColor)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setSupportWindowModes(const QList<SupportWindowMode> &supportWindowModes)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setMinWindowWidth(int minWindowWidth)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setMinWindowHeight(int minWindowHeight)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setMaxWindowWidth(int maxWindowWidth)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setMaxWindowHeight(int maxWindowHeight)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setHideStartWindow(bool hideStartWindow)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setWindowCreateParams(const WindowCreateParams &windowCreateParams)
    ...
    */
    ...
    /*!
        \fn QtHarmonyExtras::StartOptions::setCompletionHandler(QObject *context, std::function<void(bool, ElementName, QString)> callback)
...
/*!
    \fn std::shared_ptr<QtHarmonyExtras::WindowCreateParams> QtHarmonyExtras::createWindowCreateParams()
...
/*!
    \fn std::shared_ptr<QtHarmonyExtras::StartOptions> QtHarmonyExtras::createStartOptions()
