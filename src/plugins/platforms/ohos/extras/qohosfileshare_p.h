...
#ifndef QOHOSFILESHARE_P_H
#define QOHOSFILESHARE_P_H
...
class Q_HARMONYEXTRAS_EXPORT ActionResult
{
public:
...
class Q_HARMONYEXTRAS_EXPORT CheckResult
{
public:
    virtual std::shared_ptr<OperationStatus> operationStatus() const = 0;
...
Q_HARMONYEXTRAS_EXPORT std::shared_ptr<ActionResult> persistPermission(const QList<PathPolicy> &policies);
Q_HARMONYEXTRAS_EXPORT std::shared_ptr<ActionResult> revokePermission(const QList<PathPolicy> &policies);
Q_HARMONYEXTRAS_EXPORT std::shared_ptr<ActionResult> activatePermission(const QList<PathPolicy> &policies);
Q_HARMONYEXTRAS_EXPORT std::shared_ptr<ActionResult> deactivatePermission(const QList<PathPolicy> &policies);

Q_HARMONYEXTRAS_EXPORT std::shared_ptr<CheckResult> checkPersistent(const QList<PathPolicy> &policies);
