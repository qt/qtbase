...
#include <QtHarmonyExtras/private/qohossharekitbackend_p.h>
...
/*!
    \fn virtual QMimeType QtHarmonyExtras::ShareKit::SharedRecord::mimeType() const = 0
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::SharedRecord::content() const = 0
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::SharedRecord::filePath() const = 0
...
/*!
    \fn virtual bool QtHarmonyExtras::ShareKit::SharedRecord::isUrlContent() const = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::SharedRecord::setTitle(const QString &title) = 0
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::SharedRecord::title() const = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::SharedRecord::setLabel(const QString &label) = 0
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::SharedRecord::label() const = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::SharedRecord::setDescription(const QString &description) = 0
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::SharedRecord::description() const = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::SharedRecord::setThumbnail(const QByteArray &thumbnail) = 0
...
/*!
    \fn virtual QByteArray QtHarmonyExtras::ShareKit::SharedRecord::thumbnail() const = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::SharedRecord::setThumbnailFilePath(const QString &thumbnailFilePath) = 0
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::SharedRecord::thumbnailFilePath() const = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::SharedRecord::setExtraData(const QVariantMap &extraData) = 0
...
/*!
    \fn virtual QVariantMap QtHarmonyExtras::ShareKit::SharedRecord::extraData() const = 0
...
/*!
    \class QtHarmonyExtras::ShareKit::ShareControllerOptions
    \inmodule QtHarmonyExtras
    \since 5.12.12
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::ShareControllerOptions::setAnchorOffset(QPoint anchorOffset) = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::ShareControllerOptions::setAnchor(QRect anchor) = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::ShareControllerOptions::setSingleSelectionMode(bool singleSelectionMode) = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::ShareControllerOptions::setDefaultPreviewMode(bool defaultPreviewMode) = 0
...
/*!
    \fn virtual void QtHarmonyExtras::ShareKit::ShareControllerOptions::setExcludedAbilities(const QList<ShareAbilityType> &excludedAbilities) = 0
...
/*!
    \class QtHarmonyExtras::ShareKit::ShareOperationResult
    \inmodule QtHarmonyExtras
    \since 5.12.12
...
/*!
    \fn virtual QString QtHarmonyExtras::ShareKit::ShareOperationResult::targetAbilityName() const = 0
...
/*!
    \fn std::shared_ptr<QtHarmonyExtras::ShareKit::SharedRecord> QtHarmonyExtras::ShareKit::createContentRecord(const QMimeType &mimeType, const QString &content)

    Creates a shared "content" record with a given \a mimeType and \a content. Shared record can be created
    with content (this function) or as a file shared record \sa QtHarmonyExtras::ShareKit::createFileRecord().
    See \l {https://developer.huawei.com/consumer/en/doc/harmonyos-references/share-system-share#section20696483813}
    {SharedRecord.content}
*/
...
/*!
    \fn std::shared_ptr<QtHarmonyExtras::ShareKit::SharedRecord> QtHarmonyExtras::ShareKit::createFileRecord(const QFileInfo &fileInfo)

    Creates a shared "file" record with a given \a fileInfo. Shared record can be created
    with file (this function) or as a content record \sa QtHarmonyExtras::ShareKit::createContentRecord().
    See \l {https://developer.huawei.com/consumer/en/doc/harmonyos-references/share-system-share#section20696483813}
    {SharedRecord.uri}
*/
...
/*!
    \fn std::shared_ptr<QtHarmonyExtras::ShareKit::SharedRecord> QtHarmonyExtras::ShareKit::createUrlRecord(const QUrl &url)
...
/*!
    \fn std::shared_ptr<QtHarmonyExtras::ShareKit::ShareControllerOptions> QtHarmonyExtras::ShareKit::createControllerOptions()
