...
/*!
    \fn int QtHarmonyExtras::OnContinueContext::sourceApplicationVersionCode() const
...
/*!
    \fn void QtHarmonyExtras::AbilityContext::setDestroyFromSystemEnabled(bool destroyEnabled)
...
/*!
    \fn void QtHarmonyExtras::AbilityContext::startAbilityForResult(const QtHarmonyExtras::Want &want, std::shared_ptr<QtHarmonyExtras::StartOptions> options, QObject *context, std::function<void(std::optional<QtHarmonyExtras::StartAbilityResult>)> callback)
...
/*!
    \fn virtual bool QtHarmonyExtras::AbilityContext::tryOpenLink(const QString &link, std::shared_ptr<OpenLinkOptions> options) = 0
...
/*!
    \fn virtual void QtHarmonyExtras::AbilityContext::setContinuationActive(bool continuationActive)
...
/*!
    \class QtHarmonyExtras::AbilityContext
...
/*!
    \fn void QtHarmonyExtras::AbilityContext::newWantInfoReceived(std::shared_ptr<QtHarmonyExtras::WantInfo> wantInfo)
...
/*!
    \fn void QtHarmonyExtras::AbilityContext::continueRequestReceived(std::shared_ptr<QtHarmonyExtras::OnContinueContext> onContinueContext)
...
/*!
    \fn std::shared_ptr<OperationStatus> QtHarmonyExtras::startAbility(const Want &want, std::shared_ptr<StartOptions> options)
...
/*!
    \fn std::shared_ptr<OperationStatus> QtHarmonyExtras::startAbilityByType(const QString &appType,
...
/*!
    \fn void QtHarmonyExtras::startAppProcess(const QString &processId, const Want &requestWant, std::shared_ptr<StartOptions> options)
...
/*!
    \fn void QtHarmonyExtras::setAbilityInstanceDestroyEnabled(QWindow *instanceWindow, bool destroyEnabled)
    ...
    \sa QtHarmonyExtras::AbilityContext::setDestroyFromSystemEnabled()
*/
...
/*!
    \class QtHarmonyExtras::OnContinueContext
    \inmodule QtHarmonyExtras
    \since 5.12.12
    ...
    {UIAbility onContinue}.
*/
QtHarmonyExtras::OnContinueContext::OnContinueContext() = default;
QtHarmonyExtras::OnContinueContext::~OnContinueContext() = default;
