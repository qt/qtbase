...
DEFINEFUNC2(OSSL_PROVIDER *, OSSL_PROVIDER_load, OSSL_LIB_CTX *libctx, libctx, const char *name, name, return nullptr, return)
DEFINEFUNC(int, OSSL_PROVIDER_unload, OSSL_PROVIDER *prov, prov, return 0, return)
DEFINEFUNC(int, EVP_default_properties_is_fips_enabled, OSSL_LIB_CTX *libctx, libctx, return 0, return)
#else
...
bool q_resolveOpenSslSymbols()
{
    static bool symbolsResolved = []() {
        ...
        RESOLVEFUNC(OSSL_PROVIDER_load)
        RESOLVEFUNC(OSSL_PROVIDER_unload)
        RESOLVEFUNC(EVP_default_properties_is_fips_enabled)
#else
