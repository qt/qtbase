...
bool TlsCryptographSchannel::acquireCredentialsHandle()
{
...
#endif // SUPPORTS_TLS13
    {
        SCHANNEL_CRED *cred = new SCHANNEL_CRED{
            ...
            certsCount, // cCreds
            &localCertificate, // paCred (certificate(s) containing a private key for authentication)
            nullptr, // hRootStore
                                          ...
                                          const QSslKey &privateKey)
{
    ...
    NCryptBuffer nbuffer{ ULONG(certName.size() * sizeof(char16_t) + sizeof(char16_t)),
                          NCRYPTBUFFER_PKCS_KEY_NAME,
                          const_reinterpret_cast<void *>(certName.data()) };
