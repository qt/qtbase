...
stub_arm64.commands = $$QMAKE_CXX $(CXXFLAGS) -shared -arch arm64 -o stub.arm64.dylib $$PWD/stub.cpp
stub_arm64.depends += $$PWD/stub.cpp

stub_x86_64.commands = $$QMAKE_CXX $(CXXFLAGS) -shared -arch x86_64 -o stub.x86_64.dylib $$PWD/stub.cpp
