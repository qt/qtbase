...
function(check_cydx_v1_6_dependencies)
    ...
    while(idx LESS dependencies_length)
        ...
        string(JSON depends_on_length ERROR_VARIABLE depends_on_error LENGTH "${dependency}" "dependsOn")
...
if(EXISTS "${root_result_file}")
    ...
    if(NOT EXPECTED_QT_SBOM_GENERATE_SPDX_V2 STREQUAL "" AND
            NOT "${EXPECTED_QT_SBOM_GENERATE_SPDX_V2}" STREQUAL "${RESULT_QT_SBOM_GENERATE_SPDX_V2}")
        string(APPEND RunCMake_TEST_FAILED
    ...
    if(NOT EXPECTED_QT_SBOM_GENERATE_CYDX_V1_6 STREQUAL "" AND
            NOT "${EXPECTED_QT_SBOM_GENERATE_CYDX_V1_6}" STREQUAL "${RESULT_QT_SBOM_GENERATE_CYDX_V1_6}")
        string(APPEND RunCMake_TEST_FAILED
