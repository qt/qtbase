...
void tst_QDate::fromString_data()
{
    ...
    QTest::newRow("yyyyMMdd") << u"20240412"_s << u"yyyyMMdd"_s;
    QTest::newRow("yyyy-MM-dd") << u"2024-04-12"_s << u"yyyy-MM-dd"_s;
    QTest::newRow("YYYYMMDD") << u"20240412"_s << u"YYYYMMDD"_s; // Invalid, QTBUG-124465.
}
