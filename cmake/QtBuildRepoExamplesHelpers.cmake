...
macro(qt_examples_build_begin)
    ...
    if(arg_EXTERNAL_BUILD AND QT_BUILD_EXAMPLES_AS_EXTERNAL)
        ...
        # Collect CMake code that each example project should run at the start of its top-level
        # project() call, see qt_internal_add_example_external_project.
        set(example_project_include_code "")
        set(QT_INTERNAL_EXAMPLE_PROJECT_INCLUDE_FILE "")

        if(QT_EXTRA_EXAMPLE_TARGET_DEFINES)
            string(APPEND example_project_include_code
                "add_compile_definitions(\${QT_EXTRA_EXAMPLE_TARGET_DEFINES})\n")
        endif()

        if(example_project_include_code)
            set(QT_INTERNAL_EXAMPLE_PROJECT_INCLUDE_FILE
                "${CMAKE_CURRENT_BINARY_DIR}/qt_internal_example_project_include.cmake")
            file(WRITE "${QT_INTERNAL_EXAMPLE_PROJECT_INCLUDE_FILE}"
                "# Generated by qt_examples_build_begin. Injected into each example project via\n"
                "# CMAKE_PROJECT_TOP_LEVEL_INCLUDES.\n"
                "${example_project_include_code}")
        endif()
        unset(example_project_include_code)
...
function(qt_internal_add_example_external_project subdir)
    ...
    if(QT_INTERNAL_EXAMPLE_PROJECT_INCLUDE_FILE)
        list(APPEND var_defs
            "-DCMAKE_PROJECT_TOP_LEVEL_INCLUDES:STRING=${QT_INTERNAL_EXAMPLE_PROJECT_INCLUDE_FILE}")
    endif()
