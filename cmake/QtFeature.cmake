...
function(qt_get_platform_try_compile_vars out_var)
    ...
    foreach(__qt_platform IN ITEMS ANDROID OHOS)
        if(${__qt_platform})
            string(TOLOWER "${__qt_platform}" __qt_platform_lower)
            qt_internal_get_cmake_policy_version_minimum_assignment(${__qt_platform}
                ${__qt_platform_lower}_cmake_policy_version_minimum TYPE COMMAND_LINE)
            if(${__qt_platform_lower}_cmake_policy_version_minimum)
                list(APPEND flags_cmd_line "${${__qt_platform_lower}_cmake_policy_version_minimum}")
            endif()
        endif()
    endforeach()
    unset(__qt_platform)
    unset(__qt_platform_lower)
